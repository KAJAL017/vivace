...
@section('admin-title', $update ? 'Edit Tag' : 'Create Tag')
@section('topbar-text', $update ? 'Edit Tag' : 'Create Tag')
...
<div class="container-xxl tag-form-container">
        ...
        <div class="form-header">
            <div class="form-header-content">
                <h4>
                    ...
                    {{ $update ? 'Edit Tag' : 'Create New Tag' }}
                </h4>
                <p>{{ $update ? 'Update tag information' : 'Add a new tag to your store' }}</p>
            </div>
            <a href="{{ route('tag.index') }}" class="btn-back">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">
                                    ...
                                    <span class="hint">(e.g., New Arrival, Best Seller, Sale)</span>
                                </label>
...
<script>
    $(document).ready(function() {
        ...
        $('#tagForm').on('submit', function(e) {
            ...
            Swal.fire({
                title: 'Processing...',
                text: 'Please wait while we save the tag',
