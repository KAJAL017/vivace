...
@section('topbar-text', 'Category Management')

@section('admin-css')
<style>
    /* Corporate Category List */
    .category-container {
        padding: 2rem 0;
    }
...
<div class="container-xxl category-container">
    ...
    <div class="row stats-row g-3">
        <div class="col-xl-3 col-md-6">
            <div class="stat-card">
                @php
                    $totalCategories = DB::table('categories')->where('is_deleted', 0)->count();
                @endphp
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card blue">
                @php
                    $topBarCategories = DB::table('categories')->where('is_deleted', 0)->where('show_in_top_bar', 1)->count();
                @endphp
                <div class="stat-value">{{ $topBarCategories }}</div>
                <div class="stat-label">Top Bar Categories</div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="stat-card purple">
                @php
                    $totalProducts = DB::table('products')->where('is_deleted', 0)->whereNotNull('category_id')->count();
                @endphp
        ...
        <form id="filterForm" method="GET" action="{{ route('category.index') }}">
            <div class="filter-row">
                <div class="filter-group">
                    ...
                    <input type="text" name="search" class="filter-input" placeholder="Search by category name..." 
    ...
    <div class="category-card">
        <div class="card-header-custom">
            ...
            <a href="{{ route('category.create') }}" class="btn btn-add-category">
...
@section('admin-js')
<script>
    var deleteUrl = "{{ route('category.destroy', ['id' => ':id']) }}";
    
    $(document).ready(function() {
        // Function to load categories with AJAX
        function loadCategories(page = 1) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#categoryTableContainer').html(response.table + response.pagination);
