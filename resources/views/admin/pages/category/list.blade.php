                            ...
                            <table class="text-center" id="export-button">
                                <thead class="theadColor">
                                    <tr class="text-uppercase text-center">
                                        ...
                                        <th>Image</th>
                                        <th>Name</th>
                                        <th>Show In Top Bar</th>
                                        <th>ACTION</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($categories as $key => $category)
                                        <tr data-id="{{$category->id }}" class="text-center">
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                <img src="{{ url('public/uploads/'.$category->image.'') }}" alt="" width="50">
                                            </td>
                                            <td>{{$category->name }}</td>
                                            <td>{{$category->show_in_top_bar == 1 ? 'Active' : 'In Active' }}</td>
