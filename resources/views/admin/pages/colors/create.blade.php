                            ...
                            <form id="categoryForm" class="row g-3 needs-validation" novalidate enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="name" class="form-control" id="validationCustom01"
                                        required placeholder="Enter Color Name" value="{{ $name }}">
                                </div>
                                <div class="col-md-12">
                                    <label for="validationCustom02" class="form-label">Color Hex Code</label>
                                    <input type="text" name="hex_code" class="form-control" id="validationCustom02"
                                        required placeholder="Enter Hex Code" value="{{ $hex_code }}">
                                </div>
                                <div class="col-12">
