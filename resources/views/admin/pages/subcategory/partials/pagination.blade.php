...
<div class="pagination-container">
    <div class="pagination-wrapper">
        <ul class="pagination-list">
            ...
            @else
                <li class="page-item">
                    <a class="page-link" href="javascript:void(0)" data-page="{{ $sub_categories->currentPage() - 1 }}">
                        <iconify-icon icon="solar:alt-arrow-left-bold"></iconify-icon>
                    </a>
                </li>
            @endif
            ...
            {{-- Page Numbers --}}
            @php
                $currentPage = $sub_categories->currentPage();
                $lastPage = $sub_categories->lastPage();
        ...
        <div class="pagination-info">
            Showing {{ $sub_categories->firstItem() }} to {{ $sub_categories->lastItem() }} of {{ $sub_categories->total() }} subcategories
        </div>
    </div>
</div>
@endif
