...
@section('admin-title', $update ? 'Edit Size' : 'Create Size')
@section('topbar-text', $update ? 'Edit Size' : 'Create Size')
...
<div class="container-xxl size-form-container">
        ...
        <div class="form-header">
            <div class="form-header-content">
                <h4>
                    ...
                    {{ $update ? 'Edit Size' : 'Create New Size' }}
                </h4>
                <p>{{ $update ? 'Update size information' : 'Add a new size to your store' }}</p>
            </div>
            <a href="{{ route('size.index') }}" class="btn-back">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="form-label">
                                    ...
                                    <span class="hint">(e.g., S, M, L, XL, XXL, 32, 34, 36)</span>
                                </label>
...
<script>
    $(document).ready(function() {
        ...
        $('#sizeForm').on('submit', function(e) {
            ...
            Swal.fire({
                title: 'Processing...',
                text: 'Please wait while we save the size',
