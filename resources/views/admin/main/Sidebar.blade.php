...
.vv-logo-link { display: flex; align-items: center; }
.vv-logo-img  { height: 36px; width: auto; object-fit: contain; filter: brightness(1.1); }
.vv-sidebar-close {
    display: none;
    background: none; border: none;
    color: var(--sb-text); cursor: pointer; padding: 4px;
...
.vv-sub-item:hover { color: var(--sb-text-h); background: #f1f5f9; }
.vv-sub-item.active { color: var(--sb-accent2); font-weight: 600; background: #eef2ff; }
...
.vv-logout:hover { background: #fef2f2; color: #ef4444; }
