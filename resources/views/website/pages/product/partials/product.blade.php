        ...
        <div class="img-wrapper">
            ...
            <div class="product-image">
                <a class="pro-first bg-size" href="{{ route('view.product', [$product->slug]) }}" style="
                    ...
                    display: block;">
                    <img class="bg-img" src="{{ path() }}/{{ Product_first_image($product->id) }}" alt="product" style="display: none;">
                </a>
                <a class="pro-sec bg-size" href="{{ route('view.product', [$product->slug]) }}" style="
                    ...
                    background-repeat: no-repeat;
                    display: block;">
                    <img class="bg-img" src="{{ path() }}/{{ get_second_image($product->id) }}" alt="product" style="display: none;">
                </a>
            </div>
        </div>
